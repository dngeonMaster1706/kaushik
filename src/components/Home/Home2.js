      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I developed a deep passion for programming and have gained proficiency in fundamental languages 
              <br />
              <br />such as 
              <i>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/dngeonMaster1706"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://x.com/Dungeon37025365"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/kaushik-borah-317758226/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://leetcode.com/u/kaushikborah4080/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
